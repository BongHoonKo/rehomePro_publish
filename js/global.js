...
function insertPageList() {
  var list = ['guide','notice-list','design-detail','design-list','design-register','index','login','member-management','mypage','phone-verify','register-complete','register-info'];
  var html = '';
